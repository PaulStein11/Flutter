...
class _BonfirePageState extends State<BonfirePage> with WidgetsBindingObserver {
  ...
  _BonfirePageState({this.bfId,
    this.ownerId,
    this.ownerName,
    this.profileImage,
    this.bfTitle,
    this.file, this.audience, this.duration});
                          ...
                          delegate: SliverChildListDelegate(
                            [
                                                              ...
                                                              ListTile(
                                                                ...
                                                                onTap:
                                                                  ...
                                                                  await showAlertDialog(
                                                                      ...
                                                                      defaultActionText:
                                                                      'Get link',
                                                                      getRequiredLink: _dynamicLinkService
                                                                          .createDynamicLink()
                              ...
                              StreamBuilder<List<Interaction>>(
                                stream: StreamService.instance.getInteractions(
                                    bfId),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                                ...
                                                child: Text(
                                                  "Interactions",
                                                  style:Theme.of(context).textTheme.headline1.copyWith(fontSize: 15.0, fontWeight: FontWeight.w600, color: Theme.of(context).accentColor.withOpacity(0.8), 
                                                  ),
                                                ),
                                              ),
                                        SizedBox(height: 8.0),
