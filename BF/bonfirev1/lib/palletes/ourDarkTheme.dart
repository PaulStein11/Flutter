...
class OurDarkTheme {
  ...
  Color _cardColor = Color(0xff2A2827);//Colors.grey.shade800.withOpacity(0.70);//
  Color _canvasColor = Color(0xff383838).withOpacity(0.85); //Drawer menu etc
  Color _primaryFont = Color(0xffe2e2e2); //BF titles, user names and timestamps
  Color _secondaryFont = Colors.grey.shade400; //Heading titles on categories
  Color _accentColor = Colors.amber.shade800;
  Color _boxColor = Color(0xff0784b5);
  ...
  ThemeData buildTheme() {
    return ThemeData(
      ...
      secondaryHeaderColor: _boxColor,
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(color: _primaryFont, width: 1.0),
          borderRadius: BorderRadius.all(Radius.circular(5.0)),
        ),
      ),
